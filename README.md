...
[![Build Status](https://travis-ci.org/s-rah/onionscan.svg?branch=onionscan-0.2)](https://travis-ci.org/s-rah/onionscan) [![Go Report Card](https://goreportcard.com/badge/.)](https://goreportcard.com/report/.)
...
See <a href="https://./wiki">the wiki</a> for guidance.
...
run `go install .` and then run the binary in `$GOPATH/bin/onionscan`.

Alternatively, you can just do `go run ..go` to run without compiling.
